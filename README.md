...
##### C语言分别用递归法和迭代法求阶乘
##### 奶牛生子的问题(腾讯面试题)
##### C语言计算用1分钱、2分钱、5分钱组成1元钱的方式C语言新娘和新郎问题
##### C语言统计输入的单词的个数

##### C语言strlenQ以NUL作为字符串结束标记，自定义一个字符串长度统计函数消除这个Bug
##### C语言将字符串转换为整数
##### C语言计算厄密多项式C语言计算一个数的平方根
